...
import { webDesigns } from "@/data/designs";
    ...
    <main className="min-h-screen pt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          ...
          <h1 className="text-4xl sm:text-5xl font-bold mb-4">Web Designs</h1>
          <p className="text-xl text-gray-600 dark:text-gray-400">
            Landing pages, web applications, and responsive website designs
          </p>
        </motion.div>
