...
const designItems = [
  { id: 1, category: "Dashboard", emoji: "📊", description: "Analytics Dashboard" },
  { id: 2, category: "Mobile", emoji: "📱", description: "Mobile App UI" },
  { id: 3, category: "Web", emoji: "💻", description: "Web Application" },
  { id: 4, category: "Dashboard", emoji: "🎨", description: "Design System" },
  { id: 5, category: "Mobile", emoji: "⚡", description: "Onboarding Flow" },
  { id: 6, category: "Web", emoji: "🔐", description: "Authentication UI" },
  { id: 7, category: "Dashboard", emoji: "📈", description: "Data Visualization" },
  { id: 8, category: "Mobile", emoji: "🎯", description: "Profile Screen" },
  { id: 9, category: "Web", emoji: "🛒", description: "E-commerce Design" },
];
