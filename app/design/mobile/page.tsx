...
import { mobileDesigns } from "@/data/designs";

export default function MobileDesigns() {
  return (
    <main className="min-h-screen pt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          ...
          <h1 className="text-4xl sm:text-5xl font-bold mb-4">Mobile App Designs</h1>
          <p className="text-xl text-gray-600 dark:text-gray-400">
            iOS and Android app interfaces, mobile-first experiences
          </p>
        </motion.div>
